...
#### --------------    Bring in data   -------------- ####
################################################################################
GPS_Dist <- readRDS("W:/VF/Optimising_VF/Eden Valley/data_prep/step4/VF4_step4.rds")
...
time.duration # "511800s (~5.92 days)"
...
saveRDS(regular_time_interval,  "W:/VF/Optimising_VF/Eden Valley/data_prep/step5/VF4_regular_time_interval.rds")
...
saveRDS(GPS_animal_reg_time_step_all,  "W:/VF/Optimising_VF/Eden Valley/data_prep/step5/VF4_step5.rds")
