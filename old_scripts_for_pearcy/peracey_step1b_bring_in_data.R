...
sp_VF1_InclusionBord <- st_as_sf(VF1_InclusionBord, coords = c("lon", "lat"), crs = 4326, agr = "constant")
head(sp_VF1_InclusionBord)
str(sp_VF1_InclusionBord)
# plot it 
sp_VF1_InclusionBord_geo <- st_geometry(sp_VF1_InclusionBord)
plot(sp_VF1_InclusionBord_geo, col = "grey") 


#transfor the cattle data so its in the same data frame as the paddock boundary
sp_VF1_InclusionBord_trans <- st_transform(sp_VF1_InclusionBord, crs = 28354)
head(sp_VF1_InclusionBord_trans)
head(eden_valley)
plot(st_geometry(sp_VF1_InclusionBord_trans))
sp_VF1_InclusionBord_trans_geo <- st_geometry(sp_VF1_InclusionBord_trans)#data frame that is just points no attributes
...
geom_sf(data = eden_valley, color = "black", fill = NA) +
  geom_sf(data = sp_VF1_InclusionBord_trans_geo)


############################   Now clip ################################################################

sp_VF1_InclusionBord_clip <- st_intersection(sp_VF1_InclusionBord_trans, eden_valley) #message about assumed spatial consistant

#check I have done what I want Looks good

plot(st_geometry(sp_VF1_InclusionBord_clip))
ggplot() +
 geom_sf(data = eden_valley, color = "black", fill = NA)+
geom_sf(data = sp_VF1_InclusionBord_clip)
...
sp_VF1_InclusionBord_clip <- mutate(sp_VF1_InclusionBord_clip, 
               dist = st_distance(sp_VF1_InclusionBord_clip, fence1))
head(sp_VF1_InclusionBord_clip)
ggplot() +
  geom_sf(data = eden_valley, color = "black", fill = NA) +
  geom_sf(data = fence1, color = "green", fill = NA)+
  geom_sf(data = sp_VF1_InclusionBord_clip)
#st_write(sp_VF1_InclusionBord_clip, "sp_VF1_InclusionBord_clip.csv", layer_options = "GEOMETRY=AS_XY")
...
#sp_VF1_InclusionBord_clip <- read_csv(file = "//pearceyhome.csiro.au/HOME_INTEL/ouz001/VF_cattle/Cattle_pearcey/collar logs_download2/sp_VF1_InclusionBord_clip.csv")
head(sp_VF1_InclusionBord_clip$dis)  
class(sp_VF1_InclusionBord_clip$dis)
sp_VF1_InclusionBord_clip$dist <- as.double(sp_VF1_InclusionBord_clip$dist)
#class(sp_VF1_InclusionBord_clip$time)

#head(sp_VF1_InclusionBord_clip$time)
#sp_VF1_InclusionBord_clip <- mutate(sp_VF1_InclusionBord_clip,
...
sp_VF1_InclusionBord_animalID <- mutate(sp_VF1_InclusionBord_clip,
                                                   animal_ID = case_when(
                                                     collar_ID == "ac138" ~ "Q46",
                                                     collar_ID == "ac187" ~ "Q36",
...
head(sp_VF1_InclusionBord_animalID)
str(sp_VF1_InclusionBord_animalID)
dim(sp_VF1_InclusionBord_animalID)



# which points fall inside a polygon? Create a new clm for this non_graz when true its in the non grazing zone
sp_VF1_InclusionBord_animalID <- mutate(sp_VF1_InclusionBord_animalID,
               non_graz = apply((st_intersects(sp_VF1_InclusionBord_animalID, VF1_NonGraz, sparse = FALSE)), 1, any))
head(sp_VF1_InclusionBord_animalID)
sp_VF1_InclusionBord_animalID_TRUE <- filter(sp_VF1_InclusionBord_animalID, non_graz == TRUE)
sp_VF1_InclusionBord_animalID_FALSE <- filter(sp_VF1_InclusionBord_animalID, non_graz == FALSE)
ggplot() +
  geom_sf(data = eden_valley, color = "black", fill = NA) +
  geom_sf(data = fence1, color = "green", fill = NA)+
  #geom_sf(data = sp_VF1_InclusionBord_animalID_FALSE)
  geom_sf(data = sp_VF1_InclusionBord_animalID_TRUE)
...
head(sp_VF1_InclusionBord_animalID)
##########       Final output here is  sp_VF1_InclusionBord_animalID                        ####################
st_write(sp_VF1_InclusionBord_animalID, "sp_VF1_InclusionBord_animalID.csv", layer_options = "GEOMETRY=AS_XY")
