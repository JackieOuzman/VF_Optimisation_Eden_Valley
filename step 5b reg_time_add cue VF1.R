...
GPS_Dist <- read_csv("W:/VF/Optimising_VF/Chiswick/data_prep/step3_clip.csv")
names(GPS_Dist)
...
GPS_Dist$local_time <- as.POSIXct(GPS_Dist$local_time,  tz = "Australia/Sydney")
...
start <- min(GPS_Dist$local_time, na.rm = TRUE)  # "2022-06-28 10:00:00 ACDT"
end <-   max(GPS_Dist$local_time, na.rm = TRUE) # "2022-07-02 10:10:00 ACDT"
...
time.duration # "346200s (~4.01 days)"
